...
- 打算7月之前搞定。快离职了，还需要找工作面试，找到工作之后，这块还需要再研究研究微服务的东西，在开发。

`秒杀系统之后会开发的功能`
- 优惠券
- 用户与客服（后台管理员）在网页端就可以实时聊天的功能（一无所知，又是一个大工程。😁）
- 2020年4月17日19:29:36 搞了一下layIm的在线聊天功能，有点难搞，需要先购买前端代码，服务端需要自己结合websocket开发。
- 2020年4月17日19:30:51 还是先把框架升级到cloud再说 o(^▽^)o 
- 自娱自乐 安静的研究代码就是幸福(●'◡'●)
